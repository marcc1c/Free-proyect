    ...
    public class Insecto extends Invocacion{

        public Insecto() {
        }

        public Insecto(int id, int nivel, String raza, String rareza) {
            super(id, nivel, raza, rareza);
        }

        public Insecto(String rareza, String raza, double multiExteriencia, double multiDañoCritico, double multiProbCritico, double multiDefensa, double multiAtaque, double multiVida, double dañoCritico, double probCritico, double defensa, double ataque, double vidaMaxima, double vida, double experienciaMaxima, double experiencia, int ascension, int nivel, int id) {
